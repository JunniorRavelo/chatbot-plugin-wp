(function () {
  ...
  var STRINGS = {
    es: {
      ...
      "admin.chromeTitle": "WordPress · MultiAI ChatBot",
      "admin.chromeBadge": "Admin",
      "admin.panelKicker": "Configuración",
      "admin.pillTabs": "6 pestañas integradas",
      "admin.pillPreview": "Vista previa en vivo",
      "admin.pillSecure": "Sin exponer claves API",
      ...
      "admin.general.h1": "Widget global",
      "admin.general.h2": "Respuesta en streaming",
      "admin.general.h3": "Historial opcional",
      "admin.model.title": "Modelo de IA",
      "admin.model.desc":
        "Proveedor, modelos principal y de respaldo, clave Gemini (Google IA) y URL de Ollama.",
      "admin.model.h1": "3 proveedores",
      "admin.model.h2": "Modelo de respaldo",
      "admin.model.h3": "Gemini · Ollama",
      "admin.security.title": "Seguridad",
      "admin.security.desc":
        "Orígenes permitidos, caché, telemetría, límites por IP y suspensión por abuso.",
      "admin.security.h1": "Límite por IP",
      "admin.security.h2": "Orígenes permitidos",
      "admin.security.h3": "Suspensión por abuso",
      ...
      "admin.style.h1": "9 temas visuales",
      "admin.style.h2": "Colores personalizados",
      "admin.style.h3": "Vista previa en vivo",
      "admin.stats.title": "Estadísticas",
      "admin.stats.desc": "Totales, desglose por proveedor, latencia y exportación CSV.",
      "admin.stats.h1": "KPIs en tiempo real",
      "admin.stats.h2": "Desglose por proveedor",
      "admin.stats.h3": "Exportación CSV",
      "admin.history.title": "Historial",
      "admin.history.desc":
        'Conversaciones con ID <code>CB-AAAA-MM-DD-HH-MM-SS</code>, filtros y detalle de mensajes.',
      "admin.history.h1": "ID de sesión",
      "admin.history.h2": "Filtros avanzados",
      "admin.history.h3": "Detalle de mensajes",
    ...
    en: {
      ...
      "admin.chromeTitle": "WordPress · MultiAI ChatBot",
      "admin.chromeBadge": "Admin",
      "admin.panelKicker": "Settings",
      "admin.pillTabs": "6 integrated tabs",
      "admin.pillPreview": "Live preview",
      "admin.pillSecure": "No API keys exposed",
      "admin.tab.general": "General",
      ...
      "admin.general.h1": "Global widget",
      "admin.general.h2": "Streaming responses",
      "admin.general.h3": "Optional history",
      "admin.model.title": "AI Model",
      "admin.model.desc":
        "Provider, primary and fallback models, Gemini key (Google AI), and Ollama URL.",
      "admin.model.h1": "3 providers",
      "admin.model.h2": "Fallback model",
      "admin.model.h3": "Gemini · Ollama",
      "admin.security.title": "Security",
      "admin.security.desc":
        "Allowed origins, cache, telemetry, IP limits, and abuse suspension.",
      "admin.security.h1": "Per-IP limits",
      "admin.security.h2": "Allowed origins",
      "admin.security.h3": "Abuse suspension",
      "admin.style.title": "Chat style",
      "admin.style.desc":
        "Visual templates, custom colors, widget position, and interactive preview.",
      "admin.style.h1": "9 visual themes",
      "admin.style.h2": "Custom colors",
      "admin.style.h3": "Live preview",
      "admin.stats.title": "Statistics",
      "admin.stats.desc": "Totals, breakdown by provider, latency, and CSV export.",
      "admin.stats.h1": "Real-time KPIs",
      "admin.stats.h2": "Breakdown by provider",
      "admin.stats.h3": "CSV export",
      "admin.history.title": "History",
      "admin.history.desc":
        'Conversations with ID <code>CB-AAAA-MM-DD-HH-MM-SS</code>, filters, and message detail.',
      "admin.history.h1": "Session ID",
      "admin.history.h2": "Advanced filters",
      "admin.history.h3": "Message detail",
